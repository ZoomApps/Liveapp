        ...
        formatter: {
            ...
            date: {
                ...
                masks: {
                    ...
                    //    Y - A full numeric representation of a year, 4 digits
                    LongDate: "l, d F, Y", // in jQuery UI Datepicker: "dddd, MMMM dd, yyyy"
                    ...
                    FullDateTime: "l, d F, Y g:i:s A", // in jQuery UI Datepicker: "dddd, MMMM dd, yyyy h:mm:ss tt"
                    // month day:
                    //    F - A full textual representation of a month
                    //    d - Day of the month, 2 digits with leading zeros
                    MonthDay: "d F", // in jQuery UI Datepicker: "MMMM dd"
                            ...
                            .each(function(i) {
                                ...
                                if (dval !== undefined) {
                                    ...
                                    if (t.p.treeGrid === true && nm === t.p.ExpandColumn) {
                                        ...
                                        var editor = UI.FindEditorInput(selector);
                                        if (!editor) {
                                            selector.html(vl)
                                                .attr(title);
                                        } else {
            ...
            return this.each(function() {                               
                ...
                if (pos >= 0) {
					...
					if(!$t.p.colModel[pos].skipsanitize)				
						nData = Application.SanitizeString(nData);
                    var ind = $($t)
                        .jqGrid('getGridRowById', rowid);
                    if (ind) {
...
//#region "Manipulate Data Extension"
...
//#region "Table to Grid Extension"
