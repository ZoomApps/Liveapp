...
(function( $ ) {
	...
	$.widget( "mobile.datebox", {
		...
		open: function () {
			...
			if ( o.useHeader ) {
				w.d.mainWrap.append( $( "<a href='#' data-iconpos='notext'>Close</a>" )
		...
		_stdBtn: {
			clear: function() {
				...
				return $( "<a href='#' role='button' style='width: 80%;'>" + w.__( "clearButton" ) + "</a>" )
					.addClass( 
			...
			close: function(txt) {
				var w = this, o = this.options;
				return $( "<a href='#' role='button' style='width: 80%;'>" + txt + "</a>" )
	...
	$.extend( $.mobile.datebox.prototype._build, {
		...
		"customflip": function () {
			...
			if ( o.useSetButton ) {
				...
				if ( o.useSetButton ) {
					$( "<a href='#' role='button' style='width: 80%;'>" )
						.appendTo(y)
						.text( w.__("customSet") )
						.addClass( "ui-btn ui-btn-" + o.theme +
							" ui-icon-check ui-btn-icon-left ui-shadow ui-corner-all" )
...
jQuery.extend(jQuery.mobile.datebox.prototype.options.lang, { 
	"en": {
		"setDateButtonLabel": "Set",
		"setTimeButtonLabel": "Set",
		"setDurationButtonLabel": "Set Duration",
		"calTodayButtonLabel": "Jump to Today",
